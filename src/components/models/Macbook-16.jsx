...
Files: macbook-16.glb [639.28KB] > C:\Users\Bryan\Desktop\Git Repository\personal\macbook_gsap_app\src\assets\models\macbook-16-transformed.glb [629.72KB] (1%)
...
import MacbookUrl from '../../assets/models/macbook-16-transformed.glb?url'

export default function Model(props) {
  const { nodes, materials } = useGLTF(MacbookUrl)

  const texture = useTexture(ScreenPng);
...
useGLTF.preload('../assets/models/macbook-16-transformed.glb')
